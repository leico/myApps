    ...
    switch(msg.status){
      ...
      case MIDI_POLY_AFTERTOUCH :
        ...
        if( msg.channel == _ch && msg.pitch == _pitch)
          return ofClamp(
              ofMap( msg.velocity, _min_velocity, _max_velocity, MIN_INPUT_VALUE, MAX_INPUT_VALUE)
            , MIN_INPUT_VALUE
            , MAX_INPUT_VALUE
          );
      ...
      case MIDI_NOTE_OFF:
        if( msg.channel == _ch && msg.pitch == _pitch)
          return ofClamp(
              ofMap(_min_velocity, _min_velocity, _max_velocity, MIN_INPUT_VALUE, MAX_INPUT_VALUE)
            , MIN_INPUT_VALUE
            , MAX_INPUT_VALUE
          );
      break;
