...
namespace ofxController{
  ...
  class MidiArg{
    ...
    virtual void touchDown(ofTouchEventArgs touch, Core :: MidiManager *midi) = 0;
    virtual void touchMove(ofTouchEventArgs touch, Core :: MidiManager *midi) = 0;
    virtual void touchUP  (ofTouchEventArgs touch, Core :: MidiManager *midi) = 0;
