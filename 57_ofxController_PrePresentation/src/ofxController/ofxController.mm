...
namespace ofxController{
  ...
  /* =============================================== *
   * ofxController :: addSequenser                   *
   * =============================================== */
   void ofxController :: addSequenser(
             Container   *domain
   ...
   )
   {
     ...
     Core :: Base *seq = new Sequenser(_osc, oscfunc, _midi, midifunc, rect, &_skin, bpm, steps);
     domain -> AddController(seq);
   }
