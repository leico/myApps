...
namespace ofxController{
  ...
  template<Landscape L = Vertical, Style S = Normal>
  ...
  inline void Fader<Vertical, Inverse> :: draw(void){
    ...
    ofFill();
    ofSetColor( _skin -> On() );
    ofRect(_area.x, _area.y + _area.height,  _area.width, -_data * _area.height);
  ...
  inline void Fader<Horizonal, Inverse> :: draw(void){
    ...
    ofFill();
    ofSetColor( _skin -> On() );
    ofRect( _area.x + _area.width, _area.y, -_data * _area.width, _area.height);
  }
  ...
  inline void Fader<Vertical, Bipolar> :: draw(void){
    ...
    ofRect(_area.x, _area.y + _area.height / 2, _area.width, (_data - pos) * _area.height);
  ...
  inline void Fader<Horizonal, Bipolar> :: draw(void){
    ...
    float pos = MessageIO :: MAX_INPUT_VALUE / 2;
    ofRect( _area.x + _area.width / 2, _area.y, (_data - pos) * _area.width, _area.height);
  }
  ...
  /* ===================================================== *
   * Fader<Landscape, Style> :: DrawBackground             *
   * ===================================================== */
  template<Landscape L, Style S>
