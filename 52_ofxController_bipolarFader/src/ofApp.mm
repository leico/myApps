...
void ofApp::setup(){
  ...
  con.addFader<ofxCon :: Vertical, ofxCon :: Inverse>(
      NULL
  ...
  con.addSwitch(
      NULL
    , ofRectangle(210, 300, 100, 100)
    , new ofxCon :: NormalMidi(2, 1, 0, 127)
    , new ofxCon :: TouchOSC("/Switch", 0, 1, 1, 0)
  );
  con.addPad(
      NULL
    , ofRectangle(320, 300, 100, 100)
    , new ofxCon :: NormalMidi(3, 1, 0, 127)
    , new ofxCon :: TouchOSC("/Pad", 0, 1, 1, 0)
  );
  con.addFader<ofxCon :: Horizonal, ofxCon :: Inverse>(
      NULL
    , ofRectangle(100, 700, 360, 100)
    , new ofxCon :: NormalMidi(1, 2, 0, 127)
    , new ofxCon :: TouchOSC("/HFader", 0, 1, 1, 0)
  );
